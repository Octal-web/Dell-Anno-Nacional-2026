...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Editar Mostra', link: 'Manager.Mostras.editar', params: { id: id }},
        { label: 'Cidades', link: 'Manager.Mostras.Cidades.index', params: { id: id }},
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Manager.Mostras.Cidades.novo', {id: id}), {
            preserveScroll: true
        });
        console.log(data);
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Manager.Mostras.Cidades.index', {id: id})} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
