...
const Page = () => {
    const { mostraCidade } = usePage().props;

    const [state, setState] = useState(mostraCidade.imagens);
    ...
    useEffect(() => {
        if (isReadyToUpload && data.images.length > 0) {
            post(route('Manager.Mostras.Cidades.Imagens.novo', { id: mostraCidade.id }), {
                preserveScroll: true,
                preserveState: false,
            });
    ...
    const breadcrumbItems = [
        ...
        { label: 'Cidades', link: 'Manager.Mostras.Cidades.index', params: { id: mostraCidade.mostra_ano_id }},
        { label: mostraCidade.cidade, link: 'Manager.Mostras.Cidades.editar', params: { id: mostraCidade.id }},
    ];
