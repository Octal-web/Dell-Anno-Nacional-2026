...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Etapas', link: 'Manager.Institucional.index' },
    ];
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem ', name: 'img', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: true, largura: 740, altura: 400, imagem: etapa.imagem }]
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Etapas.atualizar', {id: etapa.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faBullhorn} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={etapa.id} />
