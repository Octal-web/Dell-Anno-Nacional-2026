...
const Page = () => {
    ...
    const breadcrumbItems = [{ label: "Frame", link: "Manager.Blog.index" }];
    ...
    const inputItems = [
        ...
        [
            {
                titulo: "Título compartilhamento",
                name: "titulo_compartilhamento",
                tamanho: "col-span-12 lg:col-span-8",
                tipo: "texto",
                max: 100,
            },
        ...
        [
            {
                titulo: "Descrição compartilhamento",
                name: "descricao_compartilhamento",
                tamanho: "col-span-12 lg:col-span-8",
                editor: false,
                tipo: "texto_longo",
                max: 300,
