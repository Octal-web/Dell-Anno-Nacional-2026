...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Editar Produto', link: 'Manager.Produtos.editar', params: { id: ambiente.produto_id }},
    ];

    const inputItems = [
        [{ titulo: 'Nome', name: 'nome', tamanho: 'col-span-12 lg:col-span-8', tipo: 'texto', max: 80 }],
        [{ titulo: 'Descrição Curta', name: 'descricao_curta', tamanho: 'col-span-12 lg:col-span-8', tipo: 'texto_longo', editor: false, max: 380 }],
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Produtos.Ambientes.atualizar', {id: ambiente.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faHouse} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={ambiente.id} />
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Manager.Produtos.Ambientes.index', {id: ambiente.produto_id})} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
