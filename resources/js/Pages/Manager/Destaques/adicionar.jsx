...
const Page = () => {
    ...
    const inputItems = [
        ...
        [
            { titulo: 'Tipo', name: 'tipo', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'select', options: typeOptions },
            { titulo: 'Tamanho', name: 'tamanho', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'select', options: sizeOptions }
        ],
