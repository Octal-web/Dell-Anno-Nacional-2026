...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: true, largura: 400, altura: 600, imagem: catalogo.imagem }, { titulo: 'Arquivo Catálogo', name: 'arq', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'arquivo', arquivo: route('Manager.Catalogos.baixarArquivo', { id: catalogo.id }) }]
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Catalogos.atualizar', {id: catalogo.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faBook} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={catalogo.id} />
