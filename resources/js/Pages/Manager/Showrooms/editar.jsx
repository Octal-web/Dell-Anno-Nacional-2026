...
import { faDoorOpen, faSave, faArrowLeft, faImage } from '@fortawesome/free-solid-svg-icons';
...
const Page = () => {
    const { idioma, idiomas, showroom, lojas } = usePage().props;

    const { data, setData, post, processing, errors } = useForm(showroom);
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: true, largura: 600, altura: 550, imagem: showroom.imagem }, { titulo: 'Banner', name: 'img_banner', tamanho: 'col-span-12 md:col-span-6 lg:col-span-6', tipo: 'imagem', crop: true, largura: 1920, altura: 650, imagem: showroom.banner }]
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Showrooms.atualizar', {id: showroom.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faDoorOpen} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={showroom.id} />

            <div className="mb-6 border border-stroke bg-white px-5 py-5 shadow-md">
                <Link
                    href={route('Manager.Showrooms.Imagens.index', {id: showroom.id})}
