...
const Page = () => {
    ...
    const inputItems = [
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: true, largura: 1100, altura: 730 }]
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Manager.Campanhas.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faBullhorn} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
