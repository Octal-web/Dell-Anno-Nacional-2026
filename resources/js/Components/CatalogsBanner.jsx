...
export const CatalogsBanner = ({ content }) => {
    ...
    return (
        <section
            ref={contactBgRef}
            className="relative h-[230px] 2xl:h-[280px] max-[430px]:bg-[length:auto_120%] max-[570px]:bg-[length:200%] sm:bg-[length:170%] bg-[60%] xl:bg-[length:100%] mb-10 md:mb-16 2xl:mb-20"
            style={{
