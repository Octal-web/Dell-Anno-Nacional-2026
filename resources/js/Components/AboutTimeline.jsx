...
export const AboutTimeline = ({ slides }) => {
    ...
    return (
        <section className="pt-6 md:pt-12 2xl:pt-20 bg-black text-white">
            <div className="container max-w-large">
                <h2 className="text-4xl md:text-5xl 2xl:text-6xl font-secondary  text-center tracking-wide leading-snug mb-8 md:mb-10 2xl:mb-20">
                    Timeline
                </h2>

                <div className="relative border-b border-neutral-600 pb-4 px-10">
                    <div className="max-w-[1350px] mx-auto">
                        <Swiper
                            ...
                            breakpoints={{
                                ...
                                1024: {
                                    slidesPerView: Math.min(slides.length, 8),
                                    spaceBetween: 10,
                                },
                                1280: {
                                    slidesPerView: Math.min(slides.length, 12),
                                    spaceBetween: 10,
                                },
                            }}
                            onBeforeInit={(swiper) => {
                        ...
                        >
                            {slides.map((slide, index) => (
                                <SwiperSlide key={index}>
                                    ...
                                    >
                                        <h5
                                            className={`text-lg ${activeIndex === index ? "font-bold" : "font-light"} uppercase leading-snug p-4`}
                                        >
                                            {slide.ano}
                                        </h5>
                                    </div>
                    ...
                    >
                        <ArrowIcon className="rotate-180 fill-none stroke-white transition-all group-hover:opacity-100" />
                    </button>
                    ...
                    >
                        <ArrowIcon className="fill-none stroke-white transition-all group-hover:opacity-100" />
                    </button>
                </div>
