                ...
                <div className="container max-w-x-large">
                    <div className="flex items-center justify-between">
                        <div className="relative z-[1] flex items-center justify-between w-full my-5 md:my-7 2xl:my-8">
                            ...
                            <button
                                className={`fixed top-0 left-0 w-screen h-screen md:hidden bg-black transition-all  ${isMenuOpen ? "opacity-50" : "opacity-0 pointer-events-none"}`}
                                aria-label="Close Menu"
                                onClick={() => setIsMenuOpen(false)}
                            />

                            <div
                                className={`fixed md:relative bg-black bg-opacity-70 max-md:backdrop-blur-sm md:bg-transparent left-0 ${!isMenuOpen ? "-top-1 max-md:-translate-y-full" : "top-0"} md:left-auto md:top-auto flex flex-col md:flex-row md:items-center justify-center md:justify-end w-full h-[calc(100vh_/6_*_5)] md:h-auto md:my-0.5 2xl:my-1.5 transition-all ease-out duration-500`}
                            >
                                <nav className="relative">
                                    <img
                                        src={`/site/img/logo-white.svg`}
                                        alt="Logo"
                    ...
                    <div className="container max-w-x-large">
                        <div className="mb-1 py-8 flex max-md:flex-col gap-10 md:gap-20 md:items-end border-b border-b-white border-opacity-30">
                            <img
                                src={`/site/img/logo-white.svg`}
                                alt="Logo"
                                className="opacity-60 max-md:max-w-30"
                            />
                            ...
                            <nav className="">
                                <ul className="flex max-lg:flex-wrap justify-evenly gap-y-4 gap-x-6 sm:gap-x-4 md:gap-x-14 lg:gap-10">
                                    ...
                                    <li>
                                        <a
                                            href="https://globalliving.com.br/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="block font-secondary text-white text-sm font-light leading-none transition-all opacity-70 hover:opacity-100"
                                        >
                        ...
                        <div className="mb-1 py-5 flex max-sm:flex-col items-center">
                            <nav className="md:ml-[205px] my-2">
                                <ul className="flex max-lg:flex-wrap justify-evenly gap-y-4 gap-x-6 sm:gap-x-4 md:gap-x-14 lg:gap-10">
                                    <li>
                                        <a
                                            href="https://dellanno.com.br/illustrare/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="block font-secondary text-white text-sm font-light leading-none transition-all opacity-70 hover:opacity-100"
                                        >
                                ...
                                <ul className="flex max-lg:flex-wrap justify-evenly gap-y-4 gap-x-14 lg:gap-10">
                                    <li>
                                        <Link
                                            ...
                                            className="block text-white text-xs text-opacity-65 transition-all hover:text-opacity-100"
                                        >
                    ...
                    <div className="container max-w-x-large">
                        <div className="grid grid-cols-1 md:grid-cols-3 max-md:gap-1 items-center md:h-20 py-4 md:py-0">
                            ...
                            <span className="text-white text-xs sm:text-sm font-light text-center opacity-70 mb-5 md:mb-0 ">
                                © {new Date().getFullYear()} Dell Anno | Todos
                                os direitos reservados.
                            </span>

                            <div className="flex items-center justify-center md:justify-end gap-4">
                                <span className="text-white text-xs sm:text-sm font-light opacity-70">
                                    Criado por:{" "}
                                </span>
                                <img
