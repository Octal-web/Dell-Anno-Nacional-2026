...
const menus = [
    {
        ...
        controllers: ["Home", "Slides", "Campanhas", "Destaques"],
    },
    {
        id: 2,
        label: "Institucional",
        ...
        controllers: ["Institucional", "Acontecimentos", "Etapas"],
    },
    {
        id: 3,
        label: "Produtos",
    ...
    },
    {
        ...
        label: "Lojas",
        icon: faStore,
        href: route("Manager.Lojas.index"),
        controllers: ["Lojas"],
    },
    {
        id: 5,
        label: "Inspiração",
        icon: faStar,
        controllers: ["Showrooms", "LojasProjetos", "Mostras", "Inspiracao"],
        subMenu: [
            { label: "Inspire-se", href: route("Manager.Inspiracao.index") },
            { label: "Showrooms", href: route("Manager.Showrooms.index") },
            { label: "Projetos", href: route("Manager.Lojas.Projetos.index") },
            {
                label: "Mostras de Decoração",
    ...
    },
    {
        ...
        label: "Acabamentos",
        icon: faBorderAll,
        href: route("Manager.Acabamentos.index"),
        controllers: ["Acabamentos", "AcabamentosBlocos"],
    },
    {
        id: 7,
        label: "Blog",
        ...
        controllers: ["Blog", "Posts", "PostsCategorias"],
    },
    {
        id: 8,
        label: "Catálogos",
        icon: faBook,
        href: route("Manager.Catalogos.index"),
